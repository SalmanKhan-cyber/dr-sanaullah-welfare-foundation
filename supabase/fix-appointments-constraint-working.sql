-- Working Fix: Fix appointments foreign key constraint
-- This script handles both original and migrated schemas
...
BEGIN
    ...
    ELSE
        ...
        -- But if migration was partially run, user_id might not be unique anymore
        -- So we need to ensure user_id is unique first
